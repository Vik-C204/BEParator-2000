...
contract NoOwnerAndOwnedGenerator {
    ...
    function CreateNoOwnerFixedNoMintNoBurnNoPause(
        string memory name,
        ...
        NoOwnerFixedNoMintNoBurnNoPause token = factoryNoOwnerFixedNoMintNoBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateNoOwnerFixedNoMintCanBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        NoOwnerFixedNoMintCanBurnNoPause token = factoryNoOwnerFixedNoMintCanBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedFixedNoMintNoBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedFixedNoMintNoBurnNoPause token = factoryOwnedFixedNoMintNoBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedFixedNoMintNoBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedFixedNoMintNoBurnCanPause token = factoryOwnedFixedNoMintNoBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedFixedNoMintCanBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedFixedNoMintCanBurnCanPause token = factoryOwnedFixedNoMintCanBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedFixedNoMintCanBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedFixedNoMintCanBurnNoPause token = factoryOwnedFixedNoMintCanBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedUnlimitCanMintCanBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedUnlimitCanMintCanBurnCanPause token = factoryOwnedUnlimitCanMintCanBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedUnlimitCanMintNoBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedUnlimitCanMintNoBurnCanPause token = factoryOwnedUnlimitCanMintNoBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedUnlimitCanMintNoBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedUnlimitCanMintNoBurnNoPause token = factoryOwnedUnlimitCanMintNoBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedUnlimitCanMintCanBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedUnlimitCanMintCanBurnNoPause token = factoryOwnedUnlimitCanMintCanBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedCappedCanMintCanBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedCappedCanMintCanBurnCanPause token = factoryOwnedCappedCanMintCanBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedCappedCanMintNoBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedCappedCanMintNoBurnCanPause token = factoryOwnedCappedCanMintNoBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedCappedCanMintCanBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedCappedCanMintCanBurnNoPause token = factoryOwnedCappedCanMintCanBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateOwnedCappedCanMintNoBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        OwnedCappedCanMintNoBurnNoPause token = factoryOwnedCappedCanMintNoBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
